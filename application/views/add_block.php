...
<div class="panel panel-primary panel-shadow">
	<div class="panel-heading">
		<div class="panel-title">
			<h3><i class="entypo-location"></i>Add Block</h3>
		</div>
	...
	<?php
		...
		<div class="tab-content">
				<form id="add-block-form" method="post" action="<?=site_url('Bl/add_block')?>" class="validate" role="form" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input name="block_title" id="block_title" class="form-control" data-validate="required" />
								</div>
							</div>
