<?php
	$details = $this->district_model->get_statelist_byid($id);
	if(empty($details)){
...
<div class="panel panel-primary panel-shadow">
	<div class="panel-heading">
		<div class="panel-title">
			<h3><i class="entypo-location"></i>Update District</h3>
		</div>
	...
	<?php
		...
		<div class="tab-content">
				<form id="add-district-form" method="post" action="<?=site_url('Bl/update_district')?>" class="validate" role="form" class="form-horizontal">
				<input type="hidden" name="_id" id="_id" value="<?= $details['id'] ?>"/>
							...
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input name="district_title" id="district_title" class="form-control" data-validate="required" value="<?= $details['district_name'] ?>"/>
								</div>
							</div>
