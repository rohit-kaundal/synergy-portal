...
<?php
	...
	if(empty($singleSurvey)){
		redirect('dashboard/edit_survey');
	}
?>
...
<div class="panel panel-primary panel-shadow">
	...
	<?php
		...
		<div class="tab-content">
				<form id="add-campaign-form" method="post" action="<?= site_url('Bl/edit_survey')?>" class="validate" role="form" class="form-horizontal">
				<input type="hidden" name="_id" id="_id" value="<?= $singleSurvey->id ?>"/>
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input name="title" id="title" class="form-control" data-validate="required" placeholder="Enter title here..." value="<?= $singleSurvey->title ?>" />
										</div>
									</div>
								</div>								
							</div>
								...
								<div class="col-sm-9">
									<div class="form-group">
										...
										<div class="input-group">
											...
											<textarea class="form-control" data-validate="required" name="description" id="description" placeholder="Enter description here..."><?= $singleSurvey->description ?></textarea>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-sm-9">
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input id="keywords" name="keywords" type="text" value="<?= $singleSurvey->keywords ?>" class="form-control tagsinput" placeholder="Enter tags here" />
										</div>
									</div>
								</div>								
							</div>
